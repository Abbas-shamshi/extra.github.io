(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function node_modulesRawLoaderDistCjsJsSrcAppCanvasCanvasComponentHtml(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<canvas #myCanvas></canvas>";
      /***/
    },
    ...
    function srcAppCanvasCanvasComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CanvasComponent = /*#__PURE__*/function () {
        function CanvasComponent(platform, renderer) {
          _classCallCheck(this, CanvasComponent);

          this.platform = platform;
          this.renderer = renderer;
          this.colors = ['#e399a7', '#e27f5d', '#58b69a', '#c58794', '#e36531', '#8fa8db', '#df7a54', '#dd949d', '#e9a731', '#e1a48d', '#f2a533', '#a2c0f1', '#d9a3b1', '#ee7c36', '#5fc6de', '#e8a1b5', '#f2a533', '#f0b7a8', '#e9a4ae', '#82c62f', '#edb5a4', '#f1b132', '#86c5e4', '#e9af9d', '#f29b33', '#e399a7', '#e27f5d', '#58b69a', '#c58794', '#e36531', '#8fa8db', '#df7a54', '#dd949d', '#e9a731', '#e1a48d'];
          this.j = 5;
        ...
        _createClass(CanvasComponent, [{
          ...
          key: "handleMotionEvent",
          value: function handleMotionEvent(event) {
            var x = event.accelerationIncludingGravity.x;
            var y = event.accelerationIncludingGravity.y;
            var z = event.accelerationIncludingGravity.z;
            console.log("This is x: ".concat(x));
            console.log("This is y: ".concat(y));
            console.log("This is z: ".concat(z));
            ...
            this.myCanvasDrawingFunction(this.j); // Do something awesome.
          }
        }, {
          key: "ngOnInit",
          ...
          key: "myCanvasDrawingFunction",
          value: function myCanvasDrawingFunction(j) {
            this.ctx.moveTo(0, 0);
          ...
          key: "drawLine",
          value: function drawLine(a, b, c, d, color) {
            this.ctx.beginPath(); // if (i > 24) {
            // }
      ...
      CanvasComponent.propDecorators = {
        ...
        handleMotionEvent: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"],
          args: ['window:devicemotion', ['$event']]
        }]
      };
      CanvasComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-canvas',
